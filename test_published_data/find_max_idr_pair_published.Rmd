...
list_of_mBams = c(hlow_bam_files, published_bam_files)
...
head(countMatDiff)
 ...
 # getting the results name and addding to the coef we want to shrink
  ...
  pdf(file = paste(experiment_design_name,"IDR", idr_used,"MA_plot_all_reps.png", sep = "_"), width = 10, height = 10)
  
  print(ma_plot_labeled)
  dev.off()
  
  png(filename = paste(experiment_design_name,"IDR", idr_used,"MA_plot_all_reps.png", sep = "_"), width = 1000, height = 1000, antialias = "subpixel")
  ...
  png(filename = paste(experiment_design_name,"IDR",idr_used,"volcano_plot_all_reps.pdf", sep = "_"), width = 1000, height = 1000, antialias = "subpixel")
  print(volcano_plot_removed_reps)
  dev.off()
  
  pdf(file = paste(experiment_design_name,"IDR",idr_used,"volcano_plot_all_reps.pdf", sep = "_"), width = 10, height = 10)
  print(volcano_plot_removed_reps)
  dev.off()
